...
function AccordionTrigger({
  ...
  /* Без preflight AccordionHeaderPrimitive (реально <h3>) несёт свой
     браузерный margin — заголовок раздвигал соседей сверху и снизу на
     ~16px там, где ничего раздвигать не должно было. */
  return (
    <AccordionHeaderPrimitive className="m-0 flex">
      <AccordionTriggerPrimitive
        className={cn(
          /* Без preflight нативная кнопка несёт свой серый фон и рамку (см. тот
             же сброс у animate-ui/components/radix/tabs.tsx) — без appearance-none
             триггер выглядел постоянной таблеткой с ободком вместо строки текста. */
