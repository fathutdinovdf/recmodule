...
/* КОДЫ месторождений для номера — в ./field-codes.ts: константу читает ещё и
   экран «Справочники», а из модуля с 'use server' её не экспортировать. */
